                        ...
                        {/* Left Section */}
                                <div className="left-section">
                                        ...
                                        <div className="info-Cards">
                                                <InfoCards title="Recent Orders" icon={<img src={orderBell} className="orderBell" alt="orderBell" />} number={2} footerNum={35}/>
                                                <InfoCards title="Total Sales" icon={<img src={money} className="money" alt="money" />} number={50} footerNum={4}/>
                                                <InfoCards title="Waiting List" icon={<img src={alarmclock} className="alarmclock" alt="alarmclock" />} number={3} footerNum={2}/>
                                        </div>
                                        <div>
                                                <OrderList />
                                        </div>
